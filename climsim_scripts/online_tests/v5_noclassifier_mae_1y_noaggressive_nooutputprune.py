...
case_prefix = 'v5_noclassifier_mae_1y_noaggressive_nooutputprune'
...
f_torch_model = '/global/homes/z/zeyuanhu/scratch/hugging/E3SM-MMF_ne4/saved_models/v5_unet_nonaggressive_cliprh_mae/model.pt'
f_inp_sub     = '/global/homes/z/zeyuanhu/scratch/hugging/E3SM-MMF_ne4/saved_models/v5_unet_nonaggressive_cliprh_mae/inp_sub.txt'
f_inp_div     = '/global/homes/z/zeyuanhu/scratch/hugging/E3SM-MMF_ne4/saved_models/v5_unet_nonaggressive_cliprh_mae/inp_div.txt'
f_out_scale   = '/global/homes/z/zeyuanhu/scratch/hugging/E3SM-MMF_ne4/saved_models/v5_unet_nonaggressive_cliprh_mae/out_scale.txt'
f_qinput_log = '.true.'
f_qinput_prune = '.true.'
