...
case_prefix = 'fullynn_v5_clip_rhonly_jan_longer'
...
stop_opt,stop_n,resub,walltime = 'nmonths',12, 0,'00:30:00'

ne,npg=4,2;  num_nodes=6  ; grid=f'ne{ne}pg{npg}_ne{ne}pg{npg}'
