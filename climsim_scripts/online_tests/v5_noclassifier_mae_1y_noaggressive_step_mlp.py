...
case_prefix = 'v5_noclassifier_mae_1y_noaggressive_step_mlp'
...
f_torch_model = '/global/homes/z/zeyuanhu/scratch/hugging/E3SM-MMF_ne4/saved_models/v5_mlp_nonaggressive_cliprh_mae_step/model.pt'
f_inp_sub     = '/global/homes/z/zeyuanhu/scratch/hugging/E3SM-MMF_ne4/saved_models/v5_mlp_nonaggressive_cliprh_mae_step/inp_sub.txt'
f_inp_div     = '/global/homes/z/zeyuanhu/scratch/hugging/E3SM-MMF_ne4/saved_models/v5_mlp_nonaggressive_cliprh_mae_step/inp_div.txt'
f_out_scale   = '/global/homes/z/zeyuanhu/scratch/hugging/E3SM-MMF_ne4/saved_models/v5_mlp_nonaggressive_cliprh_mae_step/out_scale.txt'
f_qinput_log = '.true.'
f_qinput_prune = '.true.'
