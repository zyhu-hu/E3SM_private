...
case_prefix = 'control_fullysp_jan_nomlio_restart'
...
refdate = '0003-02-01' # only works for branch (and hybrid?)
...
stop_opt,stop_n,resub,walltime = 'nmonths',1, 3,'00:30:00'
...
if newcase :
   ...
   if runtype == 'branch':
      ...
      run_cmd(f'./xmlchange --file env_run.xml --id RUN_REFDIR  --val /pscratch/sd/z/zeyuanhu/e3sm_mlt_scratch/control_fullysp_jan_nomlio/run')
      run_cmd(f'./xmlchange --file env_run.xml --id GET_REFCASE --val TRUE')
      run_cmd(f'./xmlchange --file env_run.xml --id RUN_REFCASE --val control_fullysp_jan_nomlio')
