...
case_prefix = 'control_fullysp_jan_wmlio_r3_tropopause'
...
stop_opt,stop_n,resub,walltime = 'nmonths',12, 0,'24:00:00'
...
fincl2 = 'T', 'Q', 'U', 'V', 'CLDICE', 'CLDLIQ'
fincl3 = 'TMQ', 'T', 'Q', 'U', 'V', 'CLDICE', 'CLDLIQ', 'PS', 'Z3', 'PHIS'
