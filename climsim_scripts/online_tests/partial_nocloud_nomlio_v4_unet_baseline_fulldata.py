...
case_prefix = 'partial_nocloud_nomlio_v4_unet_baseline_fulldata'
exe_refcase = 'seed_partial_v4_clip_rhonly_jan_nomlio'
...
stop_opt,stop_n,resub,walltime = 'ndays',20, 7, '00:30:00'
