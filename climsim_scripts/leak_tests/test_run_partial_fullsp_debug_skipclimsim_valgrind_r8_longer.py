...
case_prefix = 'test_run_partial_fullsp_debug_skipclimsim_valgrind_r8_longer'
exe_refcase = 'test_run_partial_fullsp_debug_skipclimsim_valgrind_r8'
...
#stop_opt,stop_n,resub,walltime = 'nmonths',18, 0,'24:00:00'
stop_opt,stop_n,resub,walltime = 'nsteps',5, 0,'03:00:00'
...
f_torch_model = '/global/homes/z/zeyuanhu/scratch/hugging/E3SM-MMF_ne4/saved_models/v5_unet_qstra22_cliprh_baseline/model.pt'
