...
case_prefix = 'test_run_partial_fullsp_debug_skipclimsim_valgrind_r4_debug'
exe_refcase = 'test_run_partial_fullsp_debug_skipclimsim_valgrind_r4'
...
stop_opt,stop_n,resub,walltime = 'nsteps',1, 0,'00:30:00'
