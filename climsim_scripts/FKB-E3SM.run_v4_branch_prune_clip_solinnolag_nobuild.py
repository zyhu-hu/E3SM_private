...
case_prefix = 'prune_clip_solin_nolag_nobuild_test'
...
refdate = '0001-01-16' # only works for branch (and hybrid?)
...
f_torch_model = '/global/homes/z/zeyuanhu/scratch/hugging/E3SM-MMF_ne4/saved_models/v4_unet_fulldata_prune_clip_energyl_solin/model.pt'
