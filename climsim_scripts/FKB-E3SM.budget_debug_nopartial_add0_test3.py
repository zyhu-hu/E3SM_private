...
case_prefix = 'budget_debug_nopartial_add0_test3'
...
user_cpp = '-DCLIMSIM -DCLIMSIM_DIAG_PARTIAL' # NN hybrid test
...
refdate = '0001-02-16' # only works for branch (and hybrid?)
...
stop_opt,stop_n,resub,walltime = 'ndays',730, 0,'24:00:00'
...
fincl2 = 'T:I', 'Q:I', 'CLDLIQ:I', 'CLDICE:I', 'U:I', 'V:I', 'TS:I', 'PS:I', 'LHFLX:I', 'SHFLX:I', 'SOLIN:I', 'PRECC:I', 'PRECSC:I', 'OMEGA:I', 'RELHUM:I'
