...
case_prefix = 'example_job_submit_nn_v5_noclassifier'
# exe_refcase = ''
...
#---------------------------------------------------------------------------------------------------
# CLIMSIM
f_torch_model = '/storage/shared_e3sm/saved_models/v5/v5_unet_nonaggressive_cliprh_huber_rop2_r2/model.pt'
f_torch_model_class = '/storage/shared_e3sm/saved_models/v5/v5_classifier_lr3em4_qnlog_thred1013_smaller2_clip/model.pt'
f_inp_sub     = '/storage/shared_e3sm/saved_models/v5/v5_unet_nonaggressive_cliprh_huber_rop2_r2/inp_sub.txt'
f_inp_div     = '/storage/shared_e3sm/saved_models/v5/v5_unet_nonaggressive_cliprh_huber_rop2_r2/inp_div.txt'
f_out_scale   = '/storage/shared_e3sm/saved_models/v5/v5_unet_nonaggressive_cliprh_huber_rop2_r2/out_scale.txt'
f_qinput_log = '.true.'
f_qinput_prune = '.true.'
