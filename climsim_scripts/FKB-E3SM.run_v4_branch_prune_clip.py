...
case_prefix = 'corrected_nndebug_prune_clip_dagger_iter1'
...
f_torch_model = '/global/homes/z/zeyuanhu/scratch/hugging/E3SM-MMF_ne4/saved_models/v4_unet_baseline_fulldata_prune_clip/model.pt'
