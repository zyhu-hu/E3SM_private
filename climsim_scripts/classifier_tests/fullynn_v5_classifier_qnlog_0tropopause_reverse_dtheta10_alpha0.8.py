...
case_prefix = 'fully_v5_classifier_qnlog_0tropopause_reverse_dtheta10_alpha0.8'
exe_refcase = 'fully_v5_classifier_qnlog_0tropopause_reverse_dtheta6'
...
stop_opt,stop_n,resub,walltime = 'ndays',34, 0,'00:30:00'
