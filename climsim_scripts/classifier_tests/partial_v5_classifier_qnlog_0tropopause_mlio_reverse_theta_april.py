...
case_prefix = 'partial_v5_classifier_qnlog_0tropopause_mlio_reverse_theta_april'
exe_refcase = 'partial_no3d_v5_classifier_qnlog_0tropopause_mlio'
...
refdate = '0002-03-30' # only works for branch (and hybrid?)
...
f_torch_model = '/global/homes/z/zeyuanhu/scratch/hugging/E3SM-MMF_ne4/saved_models/v5_unet_qstra22_cliprh_reverse/model.pt'
...
f_inp_sub     = '/global/homes/z/zeyuanhu/scratch/hugging/E3SM-MMF_ne4/saved_models/v5_unet_qstra22_cliprh_reverse/inp_sub.txt'
f_inp_div     = '/global/homes/z/zeyuanhu/scratch/hugging/E3SM-MMF_ne4/saved_models/v5_unet_qstra22_cliprh_reverse/inp_div.txt'
f_out_scale   = '/global/homes/z/zeyuanhu/scratch/hugging/E3SM-MMF_ne4/saved_models/v5_unet_qstra22_cliprh_reverse/out_scale.txt'
f_qinput_log = '.true.'
f_qinput_prune = '.true.'
...
fincl3 = 'PRECT', 'PRECC', 'FLUT', 'CLOUD', 'CLDTOT', 'CLDLOW', 'CLDMED', 'CLDHGH', 'LWCF', 'SWCF', 'LHFLX', 'SHFLX', 'TMQ', 'T', 'Q', 'U', 'V', 'CLDICE', 'CLDLIQ', 'DTPHYS', 'DQ1PHYS', 'DQ2PHYS', 'DQ3PHYS', 'DUPHYS', 'PS', 'Z3', 'PHIS'
