...
case_prefix = 'ramp_step_nndebug_1step15_0step70_fixrh_noconstrain_more'
...
user_cpp = '-DCLIMSIM -DCLIMSIM_DIAG_PARTIAL -DCLIMSIMDEBUG -DMMF_ML_TRAINING' # NN hybrid test
...
cb_ramp_factor = 1.0
cb_ramp_step_0steps = 70
cb_ramp_step_1steps = 15
